...
export class RoomGateway implements OnGatewayDisconnect {
  ...
  async handleMafiaMessage(
    ...
    try {
      ...
      client.emit(RoomEvents.ERROR, { message: '마피아 메시지 처리 중 오류 발생.' });
    }
  }
  ...
  async handleEndGame(
    ...
    try {
      ...
      client.emit(RoomEvents.ERROR, { message: '게임 종료 처리 중 오류 발생.' });
    }
  }
  ...
  async handleMafiaTarget(
    ...
    try {
      ...
      client.emit(RoomEvents.ERROR, { message: '마피아 공격 처리 중 오류 발생.' });
    }
  }
  ...
  async handleDoctorTarget(
    ...
    try {
      ...
      client.emit(RoomEvents.ERROR, { message: '의사 보호 처리 중 오류 발생.' });
    }
  }
  ...
  async handlePoliceTarget(
    ...
    try {
      ...
      client.emit(RoomEvents.ERROR, { message: '경찰 조사 처리 중 오류 발생.' });
    }
  }
  ...
  async handlePoliceResult(
    ...
    try {
      ...
      if (!result.targetUserId) {
        client.emit(RoomEvents.ERROR, { message: '조사 대상이 선택되지 않았습니다.' });
        return;
      }
      ...
      client.emit(RoomEvents.ERROR, { message: '경찰 조사 결과 전송 중 오류 발생.' });
    }
  }
